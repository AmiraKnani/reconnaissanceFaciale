...
imgMira = face_recognition.load_image_file('ImagesBasic/AmiraKnanijpg')
imgMira = cv2.cvtColor(imgMira , cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('ImagesBasic/AmiraKnaniTest.JPG')
...
cv2.imshow('Amira Knani' , imgMira)
cv2.imshow('Amira Test' , imgTest)
cv2.waitKey(0)
